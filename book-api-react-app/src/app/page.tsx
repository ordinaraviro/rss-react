...
export default async function Page() {
  const res = await fetch(
    `https://openlibrary.org/search.json?q=harry&page=1&limit=10&fields=title,author_name,cover_edition_key,edition_key,first_publish_year,first_sentence,key`,
    { cache: 'no-store' }
  );
